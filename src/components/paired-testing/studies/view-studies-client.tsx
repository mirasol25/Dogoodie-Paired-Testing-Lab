...
export function ViewStudiesClient({ studies, activeStudyId }: { studies: Study[]; activeStudyId: string | null }) {
  ...
  function select(study: Study) {
    if (study.id === activeStudyId) { router.push(`/studies/${study.id}`); return; }
