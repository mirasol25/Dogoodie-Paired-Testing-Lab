...
function formatSchedule(assignment: AssignmentSummary, timezone: string) {
  if (!assignment.scheduled_start || !assignment.scheduled_end) return "Schedule pending";
  const date = new Intl.DateTimeFormat("en", { dateStyle: "medium", timeZone: timezone }).format(new Date(assignment.scheduled_start));
  const time = new Intl.DateTimeFormat("en", { timeStyle: "short", timeZone: timezone }).format(new Date(assignment.scheduled_start));
  const end = new Intl.DateTimeFormat("en", { timeStyle: "short", timeZone: timezone }).format(new Date(assignment.scheduled_end));
