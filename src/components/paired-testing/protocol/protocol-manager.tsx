  ...
  return (
    <div className="space-y-6">
      ...
      {currentProtocol?.status === "draft" && canEdit && !viewingSelectedVersion ? <ProtocolDraftWorkspace
        ...
        thresholds={<ValidationThresholdsForm studyId={study.id} protocolId={currentProtocol.id} configuration={currentProtocol.validation_configuration} asynchronousTesting={Boolean(study.configuration && typeof study.configuration === "object" && !Array.isArray(study.configuration) && study.configuration.testing_synchronization === "asynchronous")} />}
