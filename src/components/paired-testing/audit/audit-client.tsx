...
export function AuditClient({ role, study, events, categories, options, filters }: { role: AppRole; study: { code: string; name: string; timezone: string }; events: ActivityLogEvent[]; categories: string[]; options: ActivityLogFilterOptions; filters: FilterState }) {
