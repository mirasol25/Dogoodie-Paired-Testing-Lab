...
export default async function DashboardPage() {
  ...
  if (!study) return <div className="space-y-6"><PageHeader eyebrow="Study operations" title="Study Dashboard" description="Select an accessible study to view its progress." /></div>;
