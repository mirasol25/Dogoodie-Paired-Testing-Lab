...
comment on function public.save_expert_review(uuid, public.review_status, text, text, boolean) is
  'Reviewer decisions are pending, accepted, accepted with a documented technical exception, or rejected. The legacy flagged value is retained only for historical records.';
